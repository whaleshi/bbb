    ...
    return (<div className="w-full pt-[16px]">
        <div className="flex gap-[10px] w-full">
            ...
            <div className="flex-1 flex flex-col justify-center gap-[4px]">
                ...
                <div className="text-[12px] text-[#999] flex justify-between">
                    ...
                    <div>24H <span className="text-[#41CD5A]">--</span></div>{/* EB4B6D */}
                </div>
            </div>
        </div>
        ...
        <div className="w-full px-[12px] py-[16px] border-1 border-[#F3F3F3] mt-[20px] text-[12px] text-[#999] flex flex-col gap-[12px]">
            <div className="flex justify-between">
                總量<div className="text-[#101010]">10亿</div>
            </div>
            <div className="flex justify-between">
                內盤總量<div className="text-[#101010]">8亿</div>
            </div>
            <div className="flex justify-between">
                戰壕進度<div className="text-[#101010]">{progressData.progress}%</div>
            </div>
            <div className="flex justify-between">
                合約地址<div className="text-[#101010]"><span className="underline cursor-pointer">{shortenAddress(tokenAddress)}</span><span className="text-[#999] ml-[4px] cursor-pointer">複製</span></div>
            </div>
            <div className="flex justify-between">
                發起者<div className="text-[#101010] underline cursor-pointer">{shortenAddress(tokenInfo?.creator)}</div>
            </div>
        </div>
    </div>)
}
